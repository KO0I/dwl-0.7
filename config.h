...
static float urgentcolor[]                 = COLOR(0xff5555ff);
static const char themefile[]              = "~/.cache/wallust/dwm.Xresources";
...
/* Alt matches the current dwm-6.8 comfort path and the user's selected default. */
...
static const char *wallustcmd[] = { "dwl-wallust-refresh", NULL };
static const char *barcmd[] = { "dwlb", "-toggle-visibility", "all", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_g,          setlayout,      {.v = &layouts[4]} },
